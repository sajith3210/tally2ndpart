...
class stock_itemcreation(models.Model):
    ...
    units=models.CharField(max_length=100,null=True,default=0)
    batches=models.CharField(max_length=10,null=True,default=0)
    trackdate=models.CharField(max_length=10,null=True,default=0)
    expirydate=models.CharField(max_length=10,null=True,default=0)
    gst_applicable=models.CharField(max_length=100,null=True,default=0)
    typ_sply=models.CharField(max_length=100,default=0)
    set_alter=models.CharField(max_length=100,default=0)
    rate_of_duty=models.IntegerField(default=0)
    quantity=models.CharField(max_length=100,null=True,default=0)
    rate=models.CharField(max_length=100,null=True,default=0)
    per=models.CharField(max_length=100,null=True,default=0)
    value=models.CharField(max_length=100,null=True,default=0)
