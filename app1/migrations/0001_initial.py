# Generated by Django 3.1.5 on 2022-12-28 06:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(default=0, max_length=100, null=True)),
                ('units', models.CharField(default=0, max_length=100, null=True)),
                ('batches', models.CharField(default=0, max_length=10, null=True)),
                ('trackdate', models.CharField(default=0, max_length=10, null=True)),
                ('expirydate', models.CharField(default=0, max_length=10, null=True)),
                ('gst_applicable', models.CharField(default=0, max_length=100, null=True)),
                ('typ_sply', models.CharField(default=0, max_length=100)),
                ('set_alter', models.CharField(default=0, max_length=100)),
                ...
                ('per', models.CharField(default=0, max_length=100, null=True)),
                ('value', models.CharField(default=0, max_length=100, null=True)),
                ('under', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.companies')),
            ],
        ),
        migrations.CreateModel(
